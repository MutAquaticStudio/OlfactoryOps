...
const DEFAULT_ROLE_PERMISSIONS: Record<PlatformRole, string[]> = {
  ...
  'Lab Manager': ['tenant.view', 'tenant.switch', 'members.view', 'materials.view', 'materials.edit', 'inventory.view', 'inventory.receive', 'inventory.reserve', 'inventory.consume', 'inventory.adjust', 'inventory.reverse', 'procurement.view', 'procurement.create', 'procurement.receive', 'procurement.inspect', 'notifications.view', 'notifications.manage', 'security.sessions.view', 'security.sessions.revoke'],

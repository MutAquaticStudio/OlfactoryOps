...
const DEFAULT_ROLE_PERMISSIONS: Record<PlatformRole, string[]> = {
  ...
  'Lab Manager': ['tenant.view', 'tenant.switch', 'members.view', 'materials.view', 'materials.edit', 'inventory.view', 'inventory.receive', 'inventory.reserve', 'inventory.consume', 'inventory.adjust', 'inventory.transfer', 'inventory.reverse', 'procurement.view', 'procurement.create', 'procurement.receive', 'procurement.inspect', 'trials.viewAll', 'trials.create', 'trials.release', 'trials.decide', 'sensory.view', 'sensory.evaluate', 'sensory.manage', 'production.view', 'production.create', 'production.plan', 'production.allocate', 'production.weigh', 'production.process', 'production.qc', 'production.qc.record', 'production.qc.approve', 'production.deviation.manage', 'production.cancel', 'production.close', 'production.finishedGoods.view', 'production.documents.view', 'production.documents.manage', 'commerce.view', 'orders.view', 'orders.reserve', 'orders.fulfill', 'documents.view', 'imports.view', 'imports.preview', 'imports.commit', 'bulk.preview', 'bulk.execute', 'dataops.view', 'dataops.run', 'agent.view', 'agent.execute', 'notifications.view', 'notifications.manage', 'security.sessions.view', 'security.sessions.revoke'],
  Perfumer: ['tenant.view', 'tenant.switch', 'materials.view', 'materials.viewSensitive', 'formula.view', 'formula.viewSensitive', 'formula.edit', 'formula.review', 'trials.viewAll', 'trials.create', 'sensory.view', 'sensory.evaluate', 'sensory.unblind', 'production.view', 'production.documents.view', 'optimizer.view', 'optimizer.run', 'optimizer.review', 'agent.view', 'agent.execute', 'agent.confirmWrite', 'notifications.view', 'security.sessions.view'],
  'R&D Scientist': ['tenant.view', 'materials.view', 'materials.viewSensitive', 'formula.view', 'formula.viewSensitive', 'formula.edit', 'formula.review', 'scientific_ai.use', 'scientific_ai.similarity', 'rag.view', 'sentiment.view', 'sentiment.analyze', 'optimizer.view', 'optimizer.run', 'dataops.view', 'agent.view', 'agent.execute', 'agent.evaluate', 'notifications.view', 'security.sessions.view'],
  ...
  Procurement: ['tenant.view', 'materials.view', 'suppliers.view', 'suppliers.edit', 'procurement.view', 'procurement.create', 'procurement.receive', 'imports.view', 'imports.preview', 'imports.commit', 'bulk.preview', 'bulk.execute', 'dataops.view', 'agent.view', 'agent.execute', 'notifications.view', 'security.sessions.view'],
  ...
  Brand: ['tenant.view', 'tenant.switch', 'commerce.view', 'orders.view', 'documents.view', 'notifications.view', 'security.sessions.view'],
  Supplier: ['tenant.view', 'suppliers.view', 'procurement.view', 'notifications.view', 'security.sessions.view'],
  Finance: ['tenant.view', 'billing.view', 'billing.capabilities', 'commerce.view', 'costing.view', 'costing.viewMargin', 'orders.view', 'documents.view', 'agent.view', 'agent.execute', 'notifications.view', 'security.sessions.view'],

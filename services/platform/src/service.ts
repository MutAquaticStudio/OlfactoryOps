...
const DEFAULT_ROLE_PERMISSIONS: Record<PlatformRole, string[]> = {
  ...
  'Lab Manager': ['tenant.view', 'tenant.switch', 'members.view', 'materials.view', 'materials.edit', 'inventory.view', 'inventory.receive', 'inventory.reserve', 'inventory.consume', 'inventory.adjust', 'inventory.transfer', 'inventory.reverse', 'procurement.view', 'procurement.create', 'procurement.receive', 'procurement.inspect', 'notifications.view', 'notifications.manage', 'security.sessions.view', 'security.sessions.revoke'],
  Perfumer: ['tenant.view', 'tenant.switch', 'materials.view', 'materials.viewSensitive', 'formula.view', 'formula.viewSensitive', 'formula.edit', 'formula.review', 'trials.view', 'trials.create', 'sensory.view', 'sensory.evaluate', 'notifications.view', 'security.sessions.view'],
  'R&D Scientist': ['tenant.view', 'materials.view', 'materials.viewSensitive', 'formula.view', 'formula.viewSensitive', 'formula.edit', 'formula.review', 'scientific_ai.use', 'scientific_ai.similarity', 'rag.view', 'sentiment.view', 'sentiment.analyze', 'notifications.view', 'security.sessions.view'],
  'Lab Technician': ['tenant.view', 'materials.view', 'inventory.view', 'inventory.reserve', 'inventory.consume', 'trials.view', 'sensory.view', 'sensory.evaluate', 'notifications.view', 'security.sessions.view'],
  Procurement: ['tenant.view', 'materials.view', 'suppliers.view', 'suppliers.edit', 'procurement.view', 'procurement.create', 'procurement.receive', 'notifications.view', 'security.sessions.view'],
  'Sensory Panelist': ['tenant.view', 'trials.view', 'sensory.view', 'sensory.evaluate', 'security.sessions.view'],
  Brand: ['tenant.view', 'tenant.switch', 'trials.view', 'sensory.view', 'notifications.view', 'security.sessions.view'],
  Supplier: ['tenant.view', 'suppliers.view', 'procurement.view', 'notifications.view', 'security.sessions.view'],
  Finance: ['tenant.view', 'billing.view', 'billing.capabilities', 'costing.view', 'costing.viewMargin', 'orders.view', 'notifications.view', 'security.sessions.view'],
  Viewer: ['tenant.view', 'materials.view', 'inventory.view', 'formula.view', 'trials.view', 'notifications.view', 'security.sessions.view'],
}

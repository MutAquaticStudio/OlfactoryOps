...
const DEFAULT_ROLE_PERMISSIONS: Record<PlatformRole, string[]> = {
  ...
  'R&D Scientist': ['tenant.view', 'materials.view', 'materials.viewSensitive', 'formula.view', 'formula.viewSensitive', 'formula.edit', 'formula.review', 'scientific_ai.use', 'scientific_ai.similarity', 'rag.view', 'notifications.view', 'security.sessions.view'],

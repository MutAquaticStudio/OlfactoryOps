...
const DEFAULT_ROLE_PERMISSIONS: Record<PlatformRole, string[]> = {
  ...
  'Lab Manager': ['tenant.view', 'tenant.switch', 'members.view', 'materials.view', 'materials.edit', 'inventory.view', 'inventory.receive', 'inventory.reserve', 'inventory.consume', 'inventory.adjust', 'inventory.transfer', 'inventory.reverse', 'procurement.view', 'procurement.create', 'procurement.receive', 'procurement.inspect', 'trials.viewAll', 'trials.create', 'trials.release', 'trials.decide', 'sensory.view', 'sensory.evaluate', 'sensory.manage', 'production.view', 'production.create', 'production.plan', 'production.allocate', 'production.weigh', 'production.process', 'production.qc', 'production.qc.record', 'production.qc.approve', 'production.deviation.manage', 'production.cancel', 'production.close', 'production.finishedGoods.view', 'production.documents.view', 'production.documents.manage', 'notifications.view', 'notifications.manage', 'security.sessions.view', 'security.sessions.revoke'],
  Perfumer: ['tenant.view', 'tenant.switch', 'materials.view', 'materials.viewSensitive', 'formula.view', 'formula.viewSensitive', 'formula.edit', 'formula.review', 'trials.viewAll', 'trials.create', 'sensory.view', 'sensory.evaluate', 'sensory.unblind', 'production.view', 'production.documents.view', 'notifications.view', 'security.sessions.view'],
  ...
  Viewer: ['tenant.view', 'materials.view', 'inventory.view', 'formula.view', 'trials.viewAll', 'notifications.view', 'security.sessions.view'],
}

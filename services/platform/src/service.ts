...
const DEFAULT_ROLE_PERMISSIONS: Record<PlatformRole, string[]> = {
  ...
  'Lab Technician': ['tenant.view', 'materials.view', 'inventory.view', 'inventory.reserve', 'inventory.consume', 'trials.viewAll', 'sensory.view', 'sensory.evaluate', 'notifications.view', 'security.sessions.view'],

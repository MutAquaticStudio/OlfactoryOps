...
- Material Intelligence dùng hai scope rõ ràng. Bản ghi <code>GLOBAL</code> là thư viện OlfactoryOps dùng chung, không có <code>organization_id</code> và tenant chỉ được đọc. Material tạo hoặc import trong workspace luôn là <code>TENANT</code>, bắt buộc có <code>organization_id</code> và không xuất hiện ở workspace khác. Chỉ curator thuộc workspace hệ thống mới được publish hoặc enrich metadata global; compliance, document, lot, cost và inventory của khách hàng vẫn luôn tenant-scoped.

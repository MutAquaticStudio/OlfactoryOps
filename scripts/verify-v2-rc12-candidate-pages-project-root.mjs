...
const RC12_SHA = "331c1a6054fe1420b063a2e1fe9e5cef4f043ff8";
...
export async function verifyCandidatePagesProjectRoot({
  ...
  emit("CANDIDATE_PROJECT_ROOT_RELEASE_SHA=RC12");
...
async function verifyReleaseManifest(fetchImpl, origin) {
  ...
  if (
    ...
    manifest?.fullGitSha?.toLowerCase() !== RC12_SHA ||

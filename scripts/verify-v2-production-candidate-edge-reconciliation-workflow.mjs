...
for (const value of [
  ...
  "PAGES_KNOWN_IMMUTABLE_DEPLOYMENT_FOUND",
  "PAGES_KNOWN_DEPLOYMENT_PROJECT",
  "PAGES_KNOWN_DEPLOYMENT_BRANCH",
  "PAGES_KNOWN_DEPLOYMENT_SHA",
  "PAGES_KNOWN_DEPLOYMENT_ENVIRONMENT",
  "PAGES_KNOWN_DEPLOYMENT_STAGE",
...
for (const value of [
  ...
  "String(100)",
  "PAGES_BRANCH_ALIAS_ROUTE_STATE_UNEXPECTED",
  "const results = [bare, preview, production];",
])
  if (reconciliation.includes(value))

...
test('candidate smoke is fail-closed and has no legacy public-root configuration', () => {
  ...
  expect(postBootstrapProof).toContain('PRODUCTION_DATABASE_URL: ${{ secrets.PRODUCTION_DATABASE_URL }}')
  expect(postBootstrapProof).not.toContain('PRODUCTION_CANDIDATE_ACCEPTANCE_DATABASE_URL')

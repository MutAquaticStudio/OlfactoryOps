...
} from "./verify-v2-rc13-production-candidate-browser-acceptance.mjs";
...
test("RC13 browser acceptance allows only an exact candidate tenant and RC13", () => {
...
test("RC13 browser acceptance rejects raw Pages, production, root candidate, and prior release inputs", () => {
...
test("RC13 browser auth transport accepts only JSON 4xx responses with both CORS preflights and no network failures", () => {
  const valid = {

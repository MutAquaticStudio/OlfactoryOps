...
} from "./classify-v2-rc13-inactive-upload-failure.mjs";
...
it("emits bounded token-permission evidence without exposing provider text", () => {
  ...
  expect(lines).toEqual([
    "RC13_INACTIVE_UPLOAD_COMPONENT=API",
    "RC13_INACTIVE_UPLOAD_HTTP_STATUS=403",
    "RC13_INACTIVE_UPLOAD_CF_ERROR_CODE=10000",
    "RC13_INACTIVE_UPLOAD_FAILURE_CLASS=CLOUDFLARE_TOKEN_PERMISSION",
  ]);

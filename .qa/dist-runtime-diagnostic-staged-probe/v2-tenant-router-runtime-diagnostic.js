...
function createPrismaRuntimeProbeExecutor(env, hostname) {
  const prisma = new import_client.PrismaClient({
    adapter: new PrismaPgAdapterFactory({
  ...
  return {
    ...
    disconnect: /* @__PURE__ */ __name(() => prisma.$disconnect(), "disconnect")
  };
}
__name(createPrismaRuntimeProbeExecutor, "createPrismaRuntimeProbeExecutor");
...
async function inspectCandidateRuntime(env, createExecutor = createPrismaRuntimeProbeExecutor) {
